...
#define TIMER2 60000/portTICK_RATE_MS
...
portTickType nextTimeout, nextTimeout2;
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
static fsm_trans_t alarma[] = { //inicaliza los estados, input, siguiente estado, output
 ...
 {ARMED, timeout_valid2, ARMED, led_off},
 {-1, NULL, -1, NULL },
};
//////////////////////////////////////////////////////////////////////////////
...
int timeout_valid2(fsm_t* fsm){
  portTickType now2 = xTaskGetTickCount();
  if(nextTimeout2 < now2){
    return 1;
  }
  else{
    return 0;
...
void led_on(fsm_t* fsm){
  nextTimeout2 = xTaskGetTickCount() + TIMER2;
  GPIO_OUTPUT_SET(2,0);
  presence=0;
}
//////////////////////////////////////////////////////////////////////////////
...
void inter2(void* ignore){
 fsm_t* fsm = fsm_new(alarma); //estados
 led_off(fsm); //inicial
